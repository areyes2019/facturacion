...
class OrdenCompraController extends Controller
{
    ...
    /**
     * Marca la mercancía como recibida; solo alcanzable desde `pagada`. Sin validación de
     * cantidades y sin efecto sobre existencias: el sistema no lleva inventario.
     */
    public function recibir(Request $request, OrdenCompra $ordenCompra): OrdenCompraResource
    {
        ...
        $ordenCompra->update(['estado' => EstadoOrdenCompra::Recibida->value]);
